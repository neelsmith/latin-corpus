...
class FunctionalMatchingSpec extends FlatSpec {
  ...
  "The LatinParsedTokenSequence object" should "test if a sequence of tokens matches a sequence of function strings" in {
  ...
  it should "filter a sequence of token sequences for those matching a sequence of function strings" in {
  ...
  it should "test if a sequence of tokens matches multiple sequences of function strings" in {
  ...
  it should  "filter a sequence of token sequeneces for those matching multiple sequences of function strings" in {
    val list1 = Vector("noun: nominative")
    val list2 = Vector("noun: genitive")
  ...
  "An implementation of the LatinParsedTokenSequence trait" should "test if its tokens' sequence matches a sequence of function strings" in {
    val requiredFunctions = Vector("noun: nominative")
    val testMatches = sentences.head.matchesFunctionStrings(requiredFunctions)
    assert(testMatches)
  }

  it should "test if its tokens' sequence matches multiple sequences of function strings" in {
    val list1 = Vector("noun: nominative")
    val list2 = Vector("noun: genitive")
